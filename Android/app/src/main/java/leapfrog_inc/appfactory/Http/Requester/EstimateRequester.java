...
public class EstimateRequester {
    ...
    public static void send(EstimateRequestData requestData, final EstimateRequesterCallback callback) {
        ...
        url.append("&");
        url.append(("chat=" + (requestData.chat ? "1" : "0")));
        url.append("&");
        url.append(("camera=" + (requestData.camera ? "1" : "0")));
        url.append("&");
        url.append(("movie=" + (requestData.movie ? "1" : "0")));
        url.append("&");
        url.append(("push=" + (requestData.push ? "1" : "0")));
        url.append("&");
        url.append(("map=" + (requestData.map ? "1" : "0")));
        url.append("&");
        url.append(("geofence=" + (requestData.geofence ? "1" : "0")));
        url.append("&");
        url.append(("settle=" + (requestData.settle ? "1" : "0")));
        url.append("&");
        url.append(("credit=" + (requestData.credit ? "1" : "0")));
        url.append("&");
        url.append(("user=" + (requestData.user ? "1" : "0")));
        url.append("&");
        url.append(("sns=" + (requestData.sns ? "1" : "0")));
        url.append("&");
